...
\begin{itemize}
\item Initialize MPI: \lstinlineCpp{main.cpp} or \lstinlineCpp{main.f90}
\item Domain decomposition: \lstinlineCpp{data.cpp} or \lstinlineCpp{main.f90}
\item Parallel linear algebra: \lstinlineCpp{linalg.cpp} or \lstinlineCpp{linalg.f90}
\item Exchange ghost cells: \lstinlineCpp{operators.cpp} or \lstinlineCpp{operators.f90}
\end{itemize}
\end{frame}
